...
<div class="scroll-wrapper" bind:this={scrollWrapper} class:simplified={isSimplified}>
    <div class="hero-container" bind:this={heroContainer}>
        ...
        <div class="hero-content" bind:this={heroContent}>
            ...
            <div class="arrow-container">
                ...
                <!-- INICIO: Texto de Scroll -->
                <p class="scroll-prompt">Desliza hacia abajo para ver la galería</p>
                <!-- FIN: Texto de Scroll -->
            </div>
        </div>
    ...
    <main bind:this={mainContent}>
        <h1 class="gallery-title">Galería Aniversario</h1>
...
/* ... (estilos hasta .bg-image-wrapper img) ... */
...
.scroll-wrapper.simplified {
    height: auto;
}
.scroll-wrapper.simplified .hero-container {
    display: none;
}
...
.gallery-title { 
    text-align: center; 
    font-size: 3rem; /* Un poco más grande para que la cursiva luzca */
    font-weight: 400; /* La mayoría de las fuentes cursivas se ven mejor sin negrita */
    letter-spacing: 1px; 
    margin: 4rem 1rem 0;
...
/* ---- INICIO: ESTILOS PARA EL SUBTÍTULO ---- */
.gallery-subtitle {
    text-align: center;
    font-size: 0.7rem;
    font-weight: 300;
    ...
    margin: 0.5rem 1rem 4rem; /* Margen superior pequeño, inferior grande */
}
/* ---- FIN ---- */
...
.arrow-container { 
    margin-top: 2rem;
    /* Se convierte en contenedor flex para alinear sus hijos */
    display: flex;
    flex-direction: column;
    align-items: center;
}
...
/* ---- INICIO: ESTILOS PARA TEXTO DE SCROLL ---- */
.scroll-prompt {
